...
public class RedistCopy {
	...
	public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject) {
		...
		if (target == BuildTarget.StandaloneWindows64) {
            ...
            CopyFile("steam_api64.dll", "steam_api64.dll", "Assets/ThirdParty/Steamworks/Plugins/x86_64", pathToBuiltProject);
        }
		else if (target == BuildTarget.StandaloneWindows) {
            //CopyFile("steam_api.dll", "steam_api.dll", "Assets/Plugins/x86", pathToBuiltProject);
            CopyFile("steam_api.dll", "steam_api.dll", "Assets/ThirdParty/Steamworks/Plugins/x86", pathToBuiltProject);
        }
