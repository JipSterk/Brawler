...
namespace Brawler.Characters
{
    public class Character : MonoBehaviour
    {
        ...
        public event Action<float> OnCharacterDamage;
        ...
        [SerializeField] [Range(0, 1)] private float _leftTriggerThreshHold = 0.5f;
        [SerializeField] [Range(0, 1)] private float _rightTriggerThreshHold = 0.5f;
        ...
        public void Update()
        {
            ...
            if (_leftTrigger > _leftTriggerThreshHold)
                Grab();
            if (_rightTrigger > _rightTriggerThreshHold)
                Grab();
